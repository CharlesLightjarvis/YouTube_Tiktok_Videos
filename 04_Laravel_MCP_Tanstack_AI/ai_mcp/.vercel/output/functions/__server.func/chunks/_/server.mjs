...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BX66vHvV.mjs");
...
const manifest = { "c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d": {
  ...
  importer: () => import("./start.server-funcs-DBayRK6n.mjs")
  ...
  importer: () => import("./demo.punk-songs-DMWh_nLf.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-6lY3RZlf.mjs");
